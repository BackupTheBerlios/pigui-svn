...
public:
	...
	virtual void seek(uint32_t p_position); ///< seek to a given position 
	virtual void seek_end(int32_t p_position=0); ///< seek from the end of file 
	virtual uint32_t get_pos(); ///< get position in the file 
	virtual uint32_t get_len(); ///< get size of the file 

	virtual bool eof_reached(); ///< reading passed EOF 

	virtual uint8_t get_8(); ///< get a byte 
